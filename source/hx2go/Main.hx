...
class Main {
    ...
    public static function main() {
        ...
        exec(absoluteInput, absoluteOutput, mainClass, singleFile, sourcelineComments, res);
    }
    ...
    public static function exec(input: String, output: String, mainClass: String, singleFile:Bool, sourcelineComments:Bool, res:Map<String, Bytes>): Void {
        ...
        generate(arc, output, mainClass, singleFile, sourcelineComments, res);

        final end = Sys.time();
        Sys.println('hx2go took ${Std.string(Math.round((end - start) * 100000) / 100)}ms');
    }

    public static function generate(archive: HxbArchive, absoluteOutput: String, mainClass: String, singleFile:Bool, sourcelineComments:Bool, res:Map<String, Bytes>): Void {
