...
extern abstract Byte {
    ...
    @:op(A / B) private inline function div(other: Byte): Float64 {
        return (this:Float64) / (other:Float64);
    }
    @:op(A / B) private inline static function hx_div_a(a: Float, b: Byte): Float64 {
        return Go.byte(a) / b;
    }
    @:op(A / B) private inline static function hx_div_b(a: Byte, b: Float): Float64 {
        return a / Go.byte(b);
    }
    @:op(A / B) private inline static function hx_div_c(a: Int, b: Byte): Float64 {
        return Go.byte(a) / b;
    }
    @:op(A / B) private inline static function hx_div_d(a: Byte, b: Int): Float64 {
        return a / Go.byte(b);
    }
    ...
    @:from public static inline function fromGoUInt(x: GoUInt): Byte {
        return Go.byte(x);
    }
    @:from public static inline function fromUInt16(x: UInt16): Byte {
        return Go.byte(x);
    }
    @:from public static inline function fromUInt32(x: UInt32): Byte {
        return Go.byte(x);
    }
    ...
    @:from public static inline function fromInt32(x: Int32): Byte {
        return Go.byte(x);
    }
