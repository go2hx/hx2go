...
extern abstract Complex128 {
    ...
    @:op(A == B) @:commutative private inline function hx_eq_a(other: Float): Bool {
        return Go.complex128(this) == other;
    }
    ...
    @:op(A < B) private inline static function hx_lt_a(a: Float, b: Complex128): Bool {
        return Go.complex128(a) < Go.complex128(b);
    }
    ...
    @:from public static inline function fromFloat(x: Float): Complex128 {
        return Go.complex128(x);
    }
    @:from public static inline function fromFloat32(x: Float32): Complex128 {
        return Go.complex128(x);
    }
