...
extern abstract Complex64 {
   ...
   @:op(A & B) private function and(other: Complex64): Complex64;
   @:op(A & B) @:commutative private inline function hx_and_a(other: Float): Complex64 {
       return this & Go.complex64(other);
   }
   @:op(A & B) @:commutative private inline function hx_and_b(other: Int): Complex64 {
       return this & Go.complex64(other);
   }
   @:op(A | B) private function or(other: Complex64): Complex64;
   @:op(A | B) @:commutative private inline function hx_or_a(other: Float): Complex64 {
       return this | Go.complex64(other);
   }
   @:op(A | B) @:commutative private inline function hx_or_b(other: Int): Complex64 {
       return this | Go.complex64(other);
   }
   @:op(A ^ B) private function xor(other: Complex64): Complex64;
   @:op(A ^ B) @:commutative private inline function hx_xor_a(other: Float): Complex64 {
       return this ^ Go.complex64(other);
   }
   @:op(A ^ B) @:commutative private inline function hx_xor_b(other: Int): Complex64 {
       return this ^ Go.complex64(other);
   }
   @:op(~A) private function not(): Complex64;
   @:op(A << B) private function lshift(other: Complex64): Complex64;
   @:op(A << B) private inline static function hx_lshift_c(a: Int, b: Complex64): Complex64 {
       return Go.complex64(a) << b;
   }
   @:op(A << B) private inline static function hx_lshift_d(a: Complex64, b: Int): Complex64 {
       return a << Go.complex64(b);
   }
   @:op(A >> B) private function rshift(other: Complex64): Complex64;
   @:op(A >> B) private inline static function hx_rshift_c(a: Int, b: Complex64): Complex64 {
       return Go.complex64(a) >> b;
   }
   @:op(A >> B) private inline static function hx_rshift_d(a: Complex64, b: Int): Complex64 {
       return a >> Go.complex64(b);
   }
   @:op(A >>> B) private function urshift(other: Complex64): Complex64;
   @:op(A >>> B) private inline static function hx_urshift_c(a: Int, b: Complex64): Complex64 {
       return Go.complex64(a) >>> b;
   }
   @:op(A >>> B) private inline static function hx_urshift_d(a: Complex64, b: Int): Complex64 {
       return a >>> Go.complex64(b);
   }
   ...
   @:from public static inline function fromComplex128(x: Complex128): Complex64 {
       return Go.complex64(x);
   }
