...
@:structInit
@:go.Type({ name: "GCMWithXORCounterNonce", instanceName: "gcm.GCMWithXORCounterNonce", imports: ["crypto/internal/fips140/aes/gcm"] })
extern class GCMWithXORCounterNonce {
    ...
    @:native("SetNoncePrefixAndMask") function setNoncePrefixAndMask(nonce: go.Slice<go.Byte>): go.Error;
