...
extern class PrecomputedValues {
    ...
    function new(dp: go.Pointer<go.math.big.Int>=null, dq: go.Pointer<go.math.big.Int>=null, qinv: go.Pointer<go.math.big.Int>=null, cRTValues: go.Slice<go.crypto.rsa.CRTValue>=null);
