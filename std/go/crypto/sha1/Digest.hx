package go.crypto.sha1;

@:structInit
@:go.Type({ name: "digest", instanceName: "sha1.digest", imports: ["crypto/sha1"] })
extern class Digest {
    ...
    @:native("ConstantTimeSum") function constantTimeSum(_in: go.Slice<go.Byte>): (go.Slice<go.Byte>);
