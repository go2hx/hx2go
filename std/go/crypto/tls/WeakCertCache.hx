...
@:structInit
@:go.Type({ name: "weakCertCache", instanceName: "tls.weakCertCache", imports: ["crypto/tls"] })
extern class WeakCertCache {

    @:native("Map") var map: go.sync.Map;

    function new(map: go.sync.Map);
