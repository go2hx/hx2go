...
extern class TbsCertificateList {
    ...
    function new(raw: go.encoding.asn1.RawContent=null, version: go.GoInt=0, signature: go.crypto.x509.pkix.AlgorithmIdentifier, issuer: go.encoding.asn1.RawValue, thisUpdate: go.time.Time, nextUpdate: go.time.Time, revokedCertificates: go.Slice<go.crypto.x509.pkix.RevokedCertificate>=null, extensions: go.Slice<go.crypto.x509.pkix.Extension>=null);
