...
function new(cmd: go.debug.macho.LoadCmd, len: go.UInt32, name: go.GoArray<go.Byte, 16>, addr: go.UInt64, memsz: go.UInt64, offset: go.UInt64, filesz: go.UInt64, maxprot: go.UInt32, prot: go.UInt32, nsect: go.UInt32, flag: go.UInt32);
