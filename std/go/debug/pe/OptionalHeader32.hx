...
extern class OptionalHeader32 {
    ...
    function new(magic: go.UInt16=0, majorLinkerVersion: go.UInt8=0, minorLinkerVersion: go.UInt8=0, sizeOfCode: go.UInt32=0, sizeOfInitializedData: go.UInt32=0, sizeOfUninitializedData: go.UInt32=0, addressOfEntryPoint: go.UInt32=0, baseOfCode: go.UInt32=0, baseOfData: go.UInt32=0, imageBase: go.UInt32=0, sectionAlignment: go.UInt32=0, fileAlignment: go.UInt32=0, majorOperatingSystemVersion: go.UInt16=0, minorOperatingSystemVersion: go.UInt16=0, majorImageVersion: go.UInt16=0, minorImageVersion: go.UInt16=0, majorSubsystemVersion: go.UInt16=0, minorSubsystemVersion: go.UInt16=0, win32VersionValue: go.UInt32=0, sizeOfImage: go.UInt32=0, sizeOfHeaders: go.UInt32=0, checkSum: go.UInt32=0, subsystem: go.UInt16=0, dllCharacteristics: go.UInt16=0, sizeOfStackReserve: go.UInt32=0, sizeOfStackCommit: go.UInt32=0, sizeOfHeapReserve: go.UInt32=0, sizeOfHeapCommit: go.UInt32=0, loaderFlags: go.UInt32=0, numberOfRvaAndSizes: go.UInt32=0, dataDirectory: go.GoArray<go.debug.pe.DataDirectory, 16>);
