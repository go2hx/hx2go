...
extern class Config {
    ...
    function new(context: go.Pointer<go.go.types.Context>=null, goVersion: String="", ignoreFuncBodies: Bool=false, fakeImportC: Bool=false, error: (err: go.Error) -> Void=null, importer: go.go.types.Importer=null, sizes: go.go.types.Sizes=null, disableUnusedImportCheck: Bool=false);
