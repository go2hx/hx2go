...
extern class T_TypeSet {
    ...
    @:go.Tuple("p0", "p1") @:native("LookupMethod") function lookupMethod(pkg: go.Pointer<go.go.types.Package>, name: std.String, foldCase: Bool): (go.Tuple<{ p0: go.GoInt, p1: go.Pointer<go.go.types.Func> }>);
