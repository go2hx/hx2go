...
@:structInit
@:go.Type({ name: "Gray", instanceName: "image.Gray", imports: ["image"] })
extern class Gray {
...
function new(pix: go.Slice<go.UInt8>, stride: go.GoInt, rect: go.image.Rectangle);
    ...
    @:native("GrayAt") function grayAt(x: go.GoInt, y: go.GoInt): go.image.color.Gray;
    ...
    @:native("SetGray") function setGray(x: go.GoInt, y: go.GoInt, c: go.image.color.Gray): Void;
