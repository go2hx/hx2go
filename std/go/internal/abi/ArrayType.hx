...
@:structInit
@:go.Type({ name: "ArrayType", instanceName: "abi.ArrayType", imports: ["internal/abi"] })
extern class ArrayType {

    @:native("Type") var type: go.internal.abi.Type;
    @:native("Elem") var elem: go.Pointer<go.internal.abi.Type>;
    @:native("Slice") var slice: go.Pointer<go.internal.abi.Type>;
    @:native("Len") var len: go.UIntPtr;

function new(type: go.internal.abi.Type, elem: go.Pointer<go.internal.abi.Type>, slice: go.Pointer<go.internal.abi.Type>, len: go.UIntPtr);
