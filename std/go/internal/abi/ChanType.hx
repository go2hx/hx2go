...
@:structInit
@:go.Type({ name: "ChanType", instanceName: "abi.ChanType", imports: ["internal/abi"] })
extern class ChanType {

    @:native("Type") var type: go.internal.abi.Type;
    @:native("Elem") var elem: go.Pointer<go.internal.abi.Type>;
    @:native("Dir") var dir: go.internal.abi.ChanDir;

function new(type: go.internal.abi.Type, elem: go.Pointer<go.internal.abi.Type>, dir: go.internal.abi.ChanDir);
