...
@:structInit
@:go.Type({ name: "StructType", instanceName: "abi.StructType", imports: ["internal/abi"] })
extern class StructType {

    @:native("Type") var type: go.internal.abi.Type;
    @:native("PkgPath") var pkgPath: go.internal.abi.Name;
    @:native("Fields") var fields: go.Slice<go.internal.abi.StructField>;

function new(type: go.internal.abi.Type, pkgPath: go.internal.abi.Name, fields: go.Slice<go.internal.abi.StructField>);
