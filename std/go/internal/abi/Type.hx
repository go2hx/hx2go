...
@:structInit
@:go.Type({ name: "Type", instanceName: "abi.Type", imports: ["internal/abi"] })
extern class Type {

    @:native("Size_") var size_: go.UIntPtr;
    @:native("PtrBytes") var ptrBytes: go.UIntPtr;
    @:native("Hash") var hash: go.UInt32;
    @:native("TFlag") var tFlag: go.internal.abi.TFlag;
    @:native("Align_") var align_: go.UInt8;
    @:native("FieldAlign_") var fieldAlign_: go.UInt8;
    @:native("Kind_") var kind_: go.internal.abi.Kind;
    @:native("Equal") var equal: (p0: go.unsafe.Pointer, p1: go.unsafe.Pointer) -> Bool;
    @:native("GCData") var gCData: go.Pointer<go.Byte>;
    @:native("Str") var str: go.internal.abi.NameOff;
    @:native("PtrToThis") var ptrToThis: go.internal.abi.TypeOff;

function new(size_: go.UIntPtr, ptrBytes: go.UIntPtr, hash: go.UInt32, tFlag: go.internal.abi.TFlag, align_: go.UInt8, fieldAlign_: go.UInt8, kind_: go.internal.abi.Kind, equal: (p0: go.unsafe.Pointer, p1: go.unsafe.Pointer) -> Bool, gCData: go.Pointer<go.Byte>, str: go.internal.abi.NameOff, ptrToThis: go.internal.abi.TypeOff);
