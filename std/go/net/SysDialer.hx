...
@:structInit
@:go.Type({ name: "sysDialer", instanceName: "net.sysDialer", imports: ["net"] })
extern class SysDialer {

    @:native("Dialer") var dialer: go.net.Dialer;
    ...
    function new(dialer: go.net.Dialer);
