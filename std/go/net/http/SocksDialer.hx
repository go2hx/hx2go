...
extern class SocksDialer {
    ...
    function new(proxyDial: (p0: go.context.Context, p1: String, p2: String) -> (go.Result<go.net.Conn>)=null, authMethods: go.Slice<go.net.http.SocksAuthMethod>=null, authenticate: (p0: go.context.Context, p1: go.io.ReadWriter, p2: go.net.http.SocksAuthMethod) -> (go.Error)=null);
