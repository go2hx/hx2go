...
extern class MemStats {
    ...
    function new(alloc: go.UInt64=0, totalAlloc: go.UInt64=0, sys: go.UInt64=0, lookups: go.UInt64=0, mallocs: go.UInt64=0, frees: go.UInt64=0, heapAlloc: go.UInt64=0, heapSys: go.UInt64=0, heapIdle: go.UInt64=0, heapInuse: go.UInt64=0, heapReleased: go.UInt64=0, heapObjects: go.UInt64=0, stackInuse: go.UInt64=0, stackSys: go.UInt64=0, mSpanInuse: go.UInt64=0, mSpanSys: go.UInt64=0, mCacheInuse: go.UInt64=0, mCacheSys: go.UInt64=0, buckHashSys: go.UInt64=0, gCSys: go.UInt64=0, otherSys: go.UInt64=0, nextGC: go.UInt64=0, lastGC: go.UInt64=0, pauseTotalNs: go.UInt64=0, pauseNs: go.GoArray<go.UInt64, 256>, pauseEnd: go.GoArray<go.UInt64, 256>, numGC: go.UInt32=0, numForcedGC: go.UInt32=0, gCCPUFraction: Float=0.0, enableGC: Bool=false, debugGC: Bool=false, bySize: go.GoArray<Dynamic, 61>);
