...
extern class Dirent {
    ...
    function new(ino: go.UInt64=0, seekoff: go.UInt64=0, reclen: go.UInt16=0, namlen: go.UInt16=0, type: go.UInt8=0, name: go.GoArray<go.Int8, 1024>, pad_cgo_0: go.GoArray<go.Byte, 3>);
