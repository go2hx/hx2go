...
extern class Statfs_t {
    ...
    function new(bsize: go.UInt32=0, iosize: go.Int32=0, blocks: go.UInt64=0, bfree: go.UInt64=0, bavail: go.UInt64=0, files: go.UInt64=0, ffree: go.UInt64=0, fsid: go.syscall.Fsid, owner: go.UInt32=0, type: go.UInt32=0, flags: go.UInt32=0, fssubtype: go.UInt32=0, fstypename: go.GoArray<go.Int8, 16>, mntonname: go.GoArray<go.Int8, 1024>, mntfromname: go.GoArray<go.Int8, 1024>, reserved: go.GoArray<go.UInt32, 8>);
