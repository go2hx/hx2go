...
extern class Termios {
    ...
    function new(iflag: go.UInt64=0, oflag: go.UInt64=0, cflag: go.UInt64=0, lflag: go.UInt64=0, cc: go.GoArray<go.UInt8, 20>, pad_cgo_0: go.GoArray<go.Byte, 4>, ispeed: go.UInt64=0, ospeed: go.UInt64=0);
