...
@:go.Type({ name: "testDeps", instanceName: "testing.testDeps", imports: ["testing"] })
extern typedef TestDeps = {
    ...
    @:go.Tuple("mode", "tearDown", "snapcov") @:native("InitRuntimeCoverage") function initRuntimeCoverage(): (go.Tuple<{ mode: String, tearDown: (coverprofile: String, gocoverdir: String) -> (go.Result<String>), snapcov: () -> (Float) }>);
    ...
    @:native("StartCPUProfile") function startCPUProfile(p0: go.io.Writer): (go.Error);
